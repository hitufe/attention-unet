...
def get_datasets_test(imgs_dir,groundTruth_dir,borderMasks_dir,train_test="null"):
    imgs = np.empty((20, height, width, 3))
...
imgs_test, groundTruth_test, border_masks_test = get_datasets_test(original_imgs_test,groundTruth_imgs_test,borderMasks_imgs_test,"test")
